-- Redefines mutation RPCs so they return lightweight payloads instead of full document snapshots.

create or replace function public.clc_build_app_meta()
returns jsonb
language sql
volatile
security definer
...
begin
  ...
  return jsonb_build_object('document', p_document) || public.clc_build_app_meta();
end;
$$;
...
revoke all on function public.clc_build_app_meta() from public;
